...
#Load text
root = '/home/mtonutti/Documents/dante_generator'
text = open('divina_commedia_7bit.txt').read().lower()
...
checkpointer = ModelCheckpoint(filepath="weights-dante.hdf5", monitor="loss",verbose=1, save_best_only=True, mode='min')

loadweights = True
if loadweights:
    model.load_weights("weights-dante.hdf5")
